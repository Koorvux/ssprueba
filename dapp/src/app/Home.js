    ...
    return (
      <div className="app">
        <div className="app-body">
          ...
          <div className="title-l">100 BNB</div>
          {this.state.ready ?
            <div>
              {this.state.hasError &&
              <div>
              ...
              {this.state.estimatedTxFee && <button className="btn" onClick={this.buyTicket}>Buy Ticket ({this.state.estimatedTxFee} BNB)</button>}
            </div> :
            <button className="btn" onClick={this.estimateTxFee}>JOIN WTH METAMASK</button>}
        </div>
      </div>
    );
  }
